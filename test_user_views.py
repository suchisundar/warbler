...
class UserViewTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.testuser = User.signup(username = 'testing',
        ...
        self.u1 = User.signup('abc','test1@testing.com','password', None)
        self.u1_id = 2006
        self.u1.id = self.u1_id
        self.u2 = User.signup('efg','test2@testing.com','password', None)
        self.u2_id = 1977
        self.u2.id = self.u2_id
        self.u3 = User.signup('mno','test3@testing.com','password', None)
        self.u3_id = 2022
    ...
    def test_users_index(self):
        with self.client as c:
            ...
            self.assertIn('@mno', str(resp.data))
    ...
    def test_users_search(self):
        with self.client as c:
            ...
            self.assertNotIn('@mno', str(resp.data))
    
    def test_user_show(self):
        m = Message(text = 'testing', user_id = self.testuser_id )
        with self.client as c:
            resp = c.get('users/1998')
    ...
    def setup_likes(self):
        m1 = Message(text = 'Testing', user_id = self.testuser_id)
        m2 = Message(text = "Going to church",  user_id = self.testuser_id)
        m3 = Message(id = 9876, text = 'liking warble', user_id = self.u1_id)
